...
def run_once(top: int, min_abs_pct: float) -> None:
    ...
    print(render(spreads, usd_krw, top, min_abs_pct))


def main() -> int:
    parser = argparse.ArgumentParser(description="Upbit vs Binance 김프/역프 모니터")
